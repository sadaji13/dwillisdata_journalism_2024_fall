...
Now the results are in the form of a data frame; both the candiates and the parties are in the column names; the 25th row has both the totals and the percentages 
