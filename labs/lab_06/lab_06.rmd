...
md_current_reg <- read_csv("data/tabula-md_active_reg.csv")

md_current_reg <- bind_cols(counties, md_current_reg)

md_current_reg
```

```{r}
md_current_reg <- md_current_reg|> rename(INACTIVE=`...11`, CONF_MAILING= INACTIVEMAILINGCONF)

md_current_reg
```

```{r}
md_current_reg <- md_current_reg|> rename(CONF_MAILING= INACTIVEMAILINGCONF)
md_current_reg
```
...
reg_by_party_2022 <- read_csv("data/tabula-2022_new_reg_by_party.csv")

reg_by_party_2022 <- reg_by_party_2022|> rename(COUNTY=...1)
