...
https://datawrapper.dwcdn.net/318ST/1/
...
md_gov_county<- md_gov_county|> 
  mutate(TOTAL = Cox+Moore+Lashar+Wallace+Harding+`Write-ins`)|> mutate(PERCENT_MOORE = (Moore/TOTAL)*100)
...
Now it's a map zoomed into MD with counties in ugly colors.
...
Now we can hover over each county and see the county name as well as each percentage of Moore votes.
...
https://datawrapper.dwcdn.net/w2rba/1/
