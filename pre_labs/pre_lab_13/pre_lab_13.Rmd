...
**Answer** Yes - but it changes slightly when run multiple times.
...
The output makes sense and suggests we do many of the things we've been doing with this data all semester. The suggestions don't necessarily match the columns we have, though.
