...
**Answer**
The code is taking the information in the election_day column and dividing it by the info in the votes column to create a new column representing the percentages of voters who voted on election day as opposed to before.
...
**Answer**
Now the percentages of voters who voted on election day are arranged in descending order. Everyone (100% of people) who voted for Laban Y. Seyoum, for example, voted on election day.
...
**Answer**
str_to_lower makes all the letters lowercase
str_to_title makes the first letter uppercase and those following lowercase
...
**Answer**
Here, the mutate function is grouping each contributor into categories based on how much they donated.
```{r}
...
**Answer**
Making a new variable to hold the result keeps things organized and now we can use and manipulate the new variable in future code.
...
**Answer:**
Changes data type from "character" to "date" and formats it in year-month-day, allowing us to filter by date.
...
**Answer**
I think the data is showing amounts spent from each month of the year except May for some reason, but from different years?? Is it showing only the months when money was spent?