...
str_to_title makes the first letter uppercase and the following lowercase
...
**Answer**
I think the data is showing amounts from each month of the year except May for some reason, but from different years??